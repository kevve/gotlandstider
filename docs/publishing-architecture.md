...
Gotlandstider is a simple static site served from the repository root with:
...
The current publishing architecture keeps that production setup intact while using Markdown content, generated static output, and lightweight build scripts.

## Principles

- Keep the homepage and public article URLs stable.
...
6. Run GitHub Actions for validation, build, and deployment to GitHub Pages.
...
- Homepage story behavior still relies on generated homepage JSON and existing frontend scripts.
